...
public class PizzaGUI extends JFrame implements ActionListener{
    ...
    private JCheckBox peppersCheck, onionsCheck, spinachCheck, oliveCheck;
    ...
    public void actionPerformed(ActionEvent event){      
        ...
        if(event.getSource() == aboutItem){
            JOptionPane.showMessageDialog(this,"Ryley Rawlings");
        }
    ...
    private void setupMenus (){
        ...
        //create a menu item for About (see below)
